...
請參考 link:https://docs.netapp.com/us-en/trident/index.html["Trident產品文檔"^] 以了解安裝和組態詳情。
...
. 將安裝歸檔下載到管理員工作站並擷取內容。目前版本的 Trident 可從 link:https://github.com/NetApp/trident/releases?q=25.&expanded=true["Trident 發布頁面位於 GitHub"^] 下載。
. 從下載的軟體包中提取Trident安裝。
+
[listing]
----
