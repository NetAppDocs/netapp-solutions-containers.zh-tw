...
. 安裝 F5 Application Services 3 擴充功能，使 BIG-IP 系統能夠接受 JSON 格式的組態，而非命令式命令。前往 link:https://github.com/F5Networks/f5-appsvcs-extension/releases["F5 AS3 GitHub 儲存庫"^]，下載最新的 RPM 檔案。
