...
將 VMware vSphere Kubernetes Service 與 NetApp ONTAP 解決方案新增至 NetApp Container 解決方案：link:https://docs.netapp.com/us-en/netapp-solutions-containers/vsphere-kubernetes-service/vks-overview.html["vSphere Kubernetes 服務解決方案"^]。
