...
. 按照 Red Hat 提供的 link:https://docs.openshift.com/container-platform/4.7/installing/index.html["安裝說明"^] 部署到您選擇的環境。
...
* link:os-on-bm.html["裸機上的 OpenShift"]
* link:os-on-openstack.html["Red Hat OpenStack 平台上的 OpenShift"]
* link:os-on-rhv.html["Red Hat 虛擬化上的 OpenShift"]
* link:os-on-vmw.html["VMware vSphere 上的 OpenShift"]
