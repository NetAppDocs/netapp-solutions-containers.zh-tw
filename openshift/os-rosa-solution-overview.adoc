...
* link:https://portal.aws.amazon.com/billing/signup["AWS 帳號"^]
* link:https://console.redhat.com/["Red Hat 帳號"^]
* 使用 IAM 使用者 link:https://www.rosaworkshop.io/rosa/1-account_setup/["具有適當的權限"^] 建立和存取 ROSA 叢集
* link:https://aws.amazon.com/cli/["AWS CLI"^]
* link:https://console.redhat.com/openshift/downloads["ROSA CLI"^]
* link:https://console.redhat.com/openshift/downloads["OpenShift 命令列介面"^] (oc)
* Helm 3 link:https://docs.aws.amazon.com/eks/latest/userguide/helm.html["文件"^]
...
使用 node-prep 標誌並以所示方式安裝 Trident。在執行安裝命令之前，您應該已經下載了安裝套件。請參閱link:https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-tridentctl.html#step-1-download-the-trident-installer-package["下載 Trident 安裝程式套件"^]。
...
Trident 後端組態告訴 Trident 如何與儲存系統（在本例中為 FSx for ONTAP）通訊。建立後端時，我們將提供要連接的儲存虛擬機器的憑證，以及叢集管理和 NFS 資料介面。我們將使用 link:https://docs.netapp.com/us-en/trident/trident-use/ontap-nas.html["ontap-nas驅動程式"^] 在 FSx 檔案系統中資源配置儲存設備 Volume。
