...
此對照表中所列的版本是本文件發佈時，用來驗證此解決方案的版本。
...
|===
其他功能會持續使用最新版本的 ONTAP、NetApp Trident 以及 Trident 支援的 Red Hat OpenShift 進行測試。如需 Trident 支援的最新 OpenShift 版本，請造訪 link:https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators["Trident 文件"^]。
